...
pub struct CWrapperContext {
    ...
    /// layers (#1473, #1551), with where their innermost value comes from.
    /// Converted by the layered decoder
    /// (`RustConversionBuilder::with_layered_choice`) instead of
...
impl CWrapperContextBuilder {
    ...
    pub fn layered_choice(
        mut self,
        param_name: String,
        leaf: crate::rust_conversion_builder::ChoiceLeaf,
    ) -> Self {
