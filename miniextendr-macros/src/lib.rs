...
fn generate_trait_impl_wrapper(trait_path: &syn::Path, type_ident: &syn::Ident) -> proc_macro2::TokenStream {
    ...
    quote::quote! {
        ...
        ///
        /// Generated by `miniextendr_module!`.
        #[repr(C)]
        #[doc(hidden)]
        ...
        /// Query function for `#type_ident` trait dispatch.
        #[doc(hidden)]
        ...
        /// Create a type-erased wrapper for `#type_ident`.
        #[doc(hidden)]
        pub fn #wrap_fn_name(data: #type_ident) -> *mut ::miniextendr_api::abi::mx_erased {
