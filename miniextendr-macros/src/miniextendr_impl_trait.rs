...
fn generate_vtable_static(
    ...
    //
    // The actual implementation will generate:
    //
    // pub static #vtable_static_name: #trait_path::#vtable_type_name =
    //     #builder_path::<#concrete_type>();
    //
    // For now, output scaffolding error
    ...
    quote::quote! {
        ...
        // TODO: Generate:
        //
        // pub static #vtable_static_name: #vtable_type_name =
        //     #builder_path::<#concrete_type>();

        compile_error!(concat!(
            "#[miniextendr_impl_trait] is not yet implemented.\n",
            "Trait: ", #trait_name_str, "\n",
            "Type: ", stringify!(#concrete_type), "\n",
            "This is scaffolding for the trait ABI system.\n",
            "\n",
            "Expected generated item:\n",
            "  pub static ", stringify!(#vtable_static_name), ": ", stringify!(#vtable_type_name), "\n",
        ));
    }
}
