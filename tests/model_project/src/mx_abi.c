 ...
 *
 * The package name ("pigworld") is substituted by configure
...
void mx_abi_register(void) {
     ...
     * Consumer packages use: R_GetCCallable("pigworld", "mx_wrap") */
    R_RegisterCCallable("pigworld", "mx_wrap", (DL_FUNC)mx_wrap);
    R_RegisterCCallable("pigworld", "mx_get", (DL_FUNC)mx_get);
    R_RegisterCCallable("pigworld", "mx_query", (DL_FUNC)mx_query);
}
