...
} else if ({ .mx_gen <- base::get("s7point_x", mode = "function"); !(inherits(.mx_gen, "S7_generic") || is.primitive(.mx_gen) || isTRUE(utils::isS3stdGeneric(.mx_gen)) || methods::isGeneric("s7point_x")) }) {
...
} else if ({ .mx_gen <- base::get("s7point_y", mode = "function"); !(inherits(.mx_gen, "S7_generic") || is.primitive(.mx_gen) || isTRUE(utils::isS3stdGeneric(.mx_gen)) || methods::isGeneric("s7point_y")) }) {
...
} else if ({ .mx_gen <- base::get("s7point_distance", mode = "function"); !(inherits(.mx_gen, "S7_generic") || is.primitive(.mx_gen) || isTRUE(utils::isS3stdGeneric(.mx_gen)) || methods::isGeneric("s7point_distance")) }) {
...
} else if ({ .mx_gen <- base::get("s7point_add", mode = "function"); !(inherits(.mx_gen, "S7_generic") || is.primitive(.mx_gen) || isTRUE(utils::isS3stdGeneric(.mx_gen)) || methods::isGeneric("s7point_add")) }) {
