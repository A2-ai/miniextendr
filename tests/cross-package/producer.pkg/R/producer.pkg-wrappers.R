...
# miniextendr-api 0.1.0 | fnv1a-64 of the normalized lines below: 0a97fb04c45028ac
...
producer_internal_probe_impl <- function() {
  .val <- .Call(C_producer_pkg_producer_internal_probe, .call = match.call())
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  .val
}
...
producer_internal_probe_explicit_own <- function() {
  .val <- .Call(C_producer_pkg_producer_internal_probe_explicit, .call = match.call())
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  .val
}
...
producer_internal_probe_renamed <- function() {
  .val <- .Call(C_producer_pkg_producer_internal_probe_r_name, .call = match.call())
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  .val
}
