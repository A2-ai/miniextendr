...
# Generated from Rust impl `StatefulCounter` (lib.rs:410:6)
...
# StatefulCounter::get_value (412:8)
#' @title Get current value (inherent method)
...
# StatefulCounter::history_len (417:8)
...
# Generated from Rust impl `Counter` for `StatefulCounter` (lib.rs:423:18)
...
# Generated from Rust impl `Resettable` for `SimpleCounter` (lib.rs:381:21)
