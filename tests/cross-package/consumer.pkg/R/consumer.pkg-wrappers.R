...
counter_raise_error <- function(counter_sexp, msg) {
  ...
  .val <- .Call(C_counter_raise_error, .call = match.call(), counter_sexp, msg)
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  invisible(.val)
}
...
counter_raise_message <- function(counter_sexp, msg) {
  ...
  .val <- .Call(C_counter_raise_message, .call = match.call(), counter_sexp, msg)
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  invisible(.val)
}
...
counter_raise_warning <- function(counter_sexp, msg) {
  ...
  .val <- .Call(C_counter_raise_warning, .call = match.call(), counter_sexp, msg)
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  invisible(.val)
}
...
counter_raise_condition_classed <- function(counter_sexp, class_name, msg) {
  ...
  .val <- .Call(C_counter_raise_condition_classed, .call = match.call(), counter_sexp, class_name, msg)
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  invisible(.val)
}
...
DoubleCounter$Counter$value <- function(x) {
  .val <- .Call(C_DoubleCounter__Counter__value, .call = match.call(), x)
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  .val
}
...
DoubleCounter$Counter$increment <- function(x) {
  .val <- .Call(C_DoubleCounter__Counter__increment, .call = match.call(), x)
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  .val
  invisible(x)
}
...
DoubleCounter$Counter$panic_plain <- function(x) {
  .val <- .Call(C_DoubleCounter__Counter__panic_plain, .call = match.call(), x)
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  .val
  invisible(x)
}
