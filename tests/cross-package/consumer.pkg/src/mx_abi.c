 ...
 *
 * The package name ("consumer.pkg") is substituted by configure
...
void mx_abi_register(void) {
     ...
     * Consumer packages use: R_GetCCallable("consumer.pkg", "mx_wrap") */
    R_RegisterCCallable("consumer.pkg", "mx_wrap", (DL_FUNC)mx_wrap);
    R_RegisterCCallable("consumer.pkg", "mx_get", (DL_FUNC)mx_get);
    R_RegisterCCallable("consumer.pkg", "mx_query", (DL_FUNC)mx_query);
}
