 ...
 *
 * The package name ("miniextendr") is substituted by configure
...
void mx_abi_register(void) {
     ...
     * Consumer packages use: R_GetCCallable("miniextendr", "mx_wrap") */
    R_RegisterCCallable("miniextendr", "mx_wrap", (DL_FUNC)mx_wrap);
    R_RegisterCCallable("miniextendr", "mx_get", (DL_FUNC)mx_get);
    R_RegisterCCallable("miniextendr", "mx_query", (DL_FUNC)mx_query);
}
