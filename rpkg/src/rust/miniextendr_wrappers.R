...
#' @export
new_percent <- function(x, unused_dots = ...) {
    .Call(C_new_percent, .call = match.call(), x, list(unused_dots))
}

#' @source Generated by miniextendr from Rust fn `vec_ptype_abbr_percent`
#' @method vec_ptype_abbr percent
#' @export
vec_ptype_abbr.percent <- function(unused_x, unused_dots = ...) {
    .Call(C_vec_ptype_abbr_percent, .call = match.call(), unused_x, list(unused_dots))
}

#' @source Generated by miniextendr from Rust fn `format_percent`
#' @method format percent
#' @export
format.percent <- function(x, unused_dots = ...) {
    .Call(C_format_percent, .call = match.call(), x, list(unused_dots))
}

#' @source Generated by miniextendr from Rust fn `vec_proxy_percent`
#' @method vec_proxy percent
#' @export
vec_proxy.percent <- function(x, unused_dots = ...) {
    .Call(C_vec_proxy_percent, .call = match.call(), x, list(unused_dots))
}

#' @source Generated by miniextendr from Rust fn `vec_restore_percent`
#' @method vec_restore percent
#' @export
vec_restore.percent <- function(x, unused_to, unused_dots = ...) {
    .Call(C_vec_restore_percent, .call = match.call(), x, unused_to, list(unused_dots))
}

#' @source Generated by miniextendr from Rust fn `vec_ptype2_percent_percent`
#' @method vec_ptype2 percent.percent
#' @export
vec_ptype2.percent.percent <- function(unused_x, unused_y, unused_dots = ...) {
    .Call(C_vec_ptype2_percent_percent, .call = match.call(), unused_x, unused_y, list(unused_dots))
}

#' @source Generated by miniextendr from Rust fn `vec_cast_percent_percent`
#' @method vec_cast percent.percent
#' @export
vec_cast.percent.percent <- function(x, unused_to, unused_dots = ...) {
    .Call(C_vec_cast_percent_percent, .call = match.call(), x, unused_to, list(unused_dots))
}

#' @source Generated by miniextendr from Rust fn `vec_cast_percent_double`
#' @method vec_cast percent.double
#' @export
vec_cast.percent.double <- function(x, unused_to, unused_dots = ...) {
    .Call(C_vec_cast_percent_double, .call = match.call(), x, unused_to, list(unused_dots))
}

#' @source Generated by miniextendr from Rust fn `vec_ptype2_percent_double`
#' @method vec_ptype2 percent.double
#' @export
vec_ptype2.percent.double <- function(unused_x, unused_y, unused_dots = ...) {
    .Call(C_vec_ptype2_percent_double, .call = match.call(), unused_x, unused_y, list(unused_dots))
}

#' @source Generated by miniextendr from Rust fn `vec_ptype2_double_percent`
#' @method vec_ptype2 double.percent
#' @export
vec_ptype2.double.percent <- function(unused_x, unused_y, unused_dots = ...) {
    .Call(C_vec_ptype2_double_percent, .call = match.call(), unused_x, unused_y, list(unused_dots))
}

#' @source Generated by miniextendr from Rust fn `vec_cast_double_percent`
#' @method vec_cast double.percent
#' @export
vec_cast.double.percent <- function(x, unused_to, unused_dots = ...) {
    .Call(C_vec_cast_double_percent, .call = match.call(), x, unused_to, list(unused_dots))
}
