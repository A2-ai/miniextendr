...
add_left_mut <- function(left, right) {
    .Call(C_add_left_mut, left, right)
}

add_right_mut <- function(left, right) {
    .Call(C_add_right_mut, left, right)
}
...
take_and_return_nothing <- function() {
    invisible(.Call(C_take_and_return_nothing))
}
...
greetings_with_named_and_unused_dots <- function(unused_dots = ...) {
    invisible(.Call(C_greetings_with_named_and_unused_dots, list(unused_dots)))
}
...
greetings_last_as_named_dots <- function(unused_exclamations, dots = ...) {
    invisible(.Call(C_greetings_last_as_named_dots, unused_exclamations, list(dots)))
}

greetings_last_as_named_and_unused_dots <- function(unused_exclamations, unused_dots = ...) {
    invisible(.Call(C_greetings_last_as_named_and_unused_dots, unused_exclamations, list(unused_dots)))
}

greetings_last_as_nameless_dots <- function(unused_exclamations, ...) {
    invisible(.Call(C_greetings_last_as_nameless_dots, unused_exclamations, list(...)))
}
