...
S7::method(s7_inc, S7Counter) <- function(x) { .Call(C_S7Counter__s7_inc, x@.ptr); x }

#' @source Generated by miniextendr from `S7Counter::s7_add`
#' @export s7_add
if (!exists("s7_add", mode = "function")) s7_add <- S7::new_generic("s7_add", "x")
S7::method(s7_add, S7Counter) <- function(x, amount) { .Call(C_S7Counter__s7_add, x@.ptr, amount); x }
...
#' @export value
if (!methods::isGeneric("value")) methods::setGeneric("value", function(x, ...) standardGeneric("value"))
#' @exportMethod value
methods::setMethod("value", "S4Counter", function(x) .Call(C_S4Counter__value, x@ptr))

#' @source Generated by miniextendr from `S4Counter::inc`
#' @export inc
if (!methods::isGeneric("inc")) methods::setGeneric("inc", function(x, ...) standardGeneric("inc"))
#' @exportMethod inc
methods::setMethod("inc", "S4Counter", function(x) .Call(C_S4Counter__inc, x@ptr))

#' @source Generated by miniextendr from `S4Counter::add`
#' @export add
if (!methods::isGeneric("add")) methods::setGeneric("add", function(x, ...) standardGeneric("add"))
#' @exportMethod add
methods::setMethod("add", "S4Counter", function(x, amount) .Call(C_S4Counter__add, x@ptr, amount))
