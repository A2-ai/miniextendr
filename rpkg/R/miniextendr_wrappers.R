...
SimpleCounter$Counter$value <- function() {
    .Call(C_SimpleCounter__Counter__value, .call = match.call(), self)
}

#' @name SimpleCounter$Counter$increment
#' @rdname SimpleCounter
SimpleCounter$Counter$increment <- function() {
    .Call(C_SimpleCounter__Counter__increment, .call = match.call(), self)
}

#' @name SimpleCounter$Counter$add
#' @rdname SimpleCounter
SimpleCounter$Counter$add <- function(n) {
    .Call(C_SimpleCounter__Counter__add, .call = match.call(), self, n)
}
...
#' @rdname PanickyCounter
PanickyCounter$Counter$value <- function() {
    .Call(C_PanickyCounter__Counter__value, .call = match.call(), self)
}

#' @name PanickyCounter$Counter$increment
#' @rdname PanickyCounter
PanickyCounter$Counter$increment <- function() {
    .Call(C_PanickyCounter__Counter__increment, .call = match.call(), self)
}

#' @name PanickyCounter$Counter$add
#' @rdname PanickyCounter
PanickyCounter$Counter$add <- function(n) {
    .Call(C_PanickyCounter__Counter__add, .call = match.call(), self, n)
}
...
#' @source Generated by miniextendr from `impl Counter for S3TraitCounter`
#' @export
if (!exists("add", mode = "function")) {
    add <- function(x, ...) UseMethod("add")
}

#' @rdname S3TraitCounter
#' @export
#' @method add S3TraitCounter
add.S3TraitCounter <- function(x, n, ...) {
    .Call(C_S3TraitCounter__Counter__add, .call = match.call(), x, n)
}
