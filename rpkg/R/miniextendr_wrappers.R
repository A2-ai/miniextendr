...
#' @rdname SimpleCounter
SimpleCounter$Counter$checked_add <- function(n) {
    .Call(C_SimpleCounter__Counter__checked_add, .call = match.call(), self, n)
}
...
#' @rdname PanickyCounter
PanickyCounter$Counter$checked_add <- function(n) {
    .Call(C_PanickyCounter__Counter__checked_add, .call = match.call(), self, n)
}
