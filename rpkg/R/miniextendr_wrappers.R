...
#' @title Counter_TraitEnv Class
#' @name Counter_TraitEnv
#' @rdname Counter_TraitEnv
#' @source Generated by miniextendr from Rust type `Counter_TraitEnv`
#' @export
Counter_TraitEnv <- new.env(parent = emptyenv())

#' @name Counter_TraitEnv$new
#' @rdname Counter_TraitEnv
Counter_TraitEnv$new <- function(v) {
    self <- .Call(C_Counter_TraitEnv__new, .call = match.call(), v)
    class(self) <- "Counter_TraitEnv"
    self
}

#' @name Counter_TraitEnv$get_value
#' @rdname Counter_TraitEnv
Counter_TraitEnv$get_value <- function() {
    .Call(C_Counter_TraitEnv__get_value, .call = match.call(), self)
}

#' @rdname Counter_TraitEnv
#' @export
`$.Counter_TraitEnv` <- function(self, name) {
    obj <- Counter_TraitEnv[[name]]
    if (is.environment(obj)) {
        # Trait namespace - bind self to all methods
        bound <- new.env(parent = emptyenv())
        for (method_name in names(obj)) {
...
#' @rdname Counter_TraitEnv
#' @export
`[[.Counter_TraitEnv` <- `$.Counter_TraitEnv`

#' @title Counter_TraitS3 Class
#' @name Counter_TraitS3
#' @rdname Counter_TraitS3
#' @source Generated by miniextendr from Rust type `Counter_TraitS3`
#' @export
Counter_TraitS3 <- new.env(parent = emptyenv())

#' @name Counter_TraitS3$new
#' @rdname Counter_TraitS3
Counter_TraitS3$new <- function(v) {
    self <- .Call(C_Counter_TraitS3__new, .call = match.call(), v)
    class(self) <- "Counter_TraitS3"
    self
}

#' @name Counter_TraitS3$get_value
#' @rdname Counter_TraitS3
Counter_TraitS3$get_value <- function() {
    .Call(C_Counter_TraitS3__get_value, .call = match.call(), self)
}

#' @rdname Counter_TraitS3
#' @export
`$.Counter_TraitS3` <- function(self, name) {
    obj <- Counter_TraitS3[[name]]
    if (is.environment(obj)) {
        # Trait namespace - bind self to all methods
        bound <- new.env(parent = emptyenv())
        for (method_name in names(obj)) {
...
#' @rdname Counter_TraitS3
#' @export
`[[.Counter_TraitS3` <- `$.Counter_TraitS3`

#' @title Counter_TraitS4 Class
#' @name Counter_TraitS4
#' @rdname Counter_TraitS4
#' @source Generated by miniextendr from Rust type `Counter_TraitS4`
#' @export
Counter_TraitS4 <- new.env(parent = emptyenv())

#' @name Counter_TraitS4$new
#' @rdname Counter_TraitS4
Counter_TraitS4$new <- function(v) {
    self <- .Call(C_Counter_TraitS4__new, .call = match.call(), v)
    class(self) <- "Counter_TraitS4"
    self
}

#' @name Counter_TraitS4$get_value
#' @rdname Counter_TraitS4
Counter_TraitS4$get_value <- function() {
    .Call(C_Counter_TraitS4__get_value, .call = match.call(), self)
}

#' @rdname Counter_TraitS4
#' @export
`$.Counter_TraitS4` <- function(self, name) {
    obj <- Counter_TraitS4[[name]]
    if (is.environment(obj)) {
        # Trait namespace - bind self to all methods
        bound <- new.env(parent = emptyenv())
        for (method_name in names(obj)) {
...
#' @rdname Counter_TraitS4
#' @export
`[[.Counter_TraitS4` <- `$.Counter_TraitS4`

#' @title Counter_TraitS7 Class
#' @name Counter_TraitS7
#' @rdname Counter_TraitS7
#' @source Generated by miniextendr from Rust type `Counter_TraitS7`
#' @export
Counter_TraitS7 <- new.env(parent = emptyenv())

#' @name Counter_TraitS7$new
#' @rdname Counter_TraitS7
Counter_TraitS7$new <- function(v) {
    self <- .Call(C_Counter_TraitS7__new, .call = match.call(), v)
    class(self) <- "Counter_TraitS7"
    self
}

#' @name Counter_TraitS7$get_value
#' @rdname Counter_TraitS7
Counter_TraitS7$get_value <- function() {
    .Call(C_Counter_TraitS7__get_value, .call = match.call(), self)
}

#' @rdname Counter_TraitS7
#' @export
`$.Counter_TraitS7` <- function(self, name) {
    obj <- Counter_TraitS7[[name]]
    if (is.environment(obj)) {
        # Trait namespace - bind self to all methods
        bound <- new.env(parent = emptyenv())
        for (method_name in names(obj)) {
...
#' @rdname Counter_TraitS7
#' @export
`[[.Counter_TraitS7` <- `$.Counter_TraitS7`

#' @title Counter_TraitR6 Class
#' @name Counter_TraitR6
#' @rdname Counter_TraitR6
#' @source Generated by miniextendr from Rust type `Counter_TraitR6`
#' @export
Counter_TraitR6 <- new.env(parent = emptyenv())

#' @name Counter_TraitR6$new
#' @rdname Counter_TraitR6
Counter_TraitR6$new <- function(v) {
    self <- .Call(C_Counter_TraitR6__new, .call = match.call(), v)
    class(self) <- "Counter_TraitR6"
    self
}

#' @name Counter_TraitR6$get_value
#' @rdname Counter_TraitR6
Counter_TraitR6$get_value <- function() {
    .Call(C_Counter_TraitR6__get_value, .call = match.call(), self)
}

#' @rdname Counter_TraitR6
#' @export
`$.Counter_TraitR6` <- function(self, name) {
    obj <- Counter_TraitR6[[name]]
    if (is.environment(obj)) {
        # Trait namespace - bind self to all methods
        bound <- new.env(parent = emptyenv())
        for (method_name in names(obj)) {
...
#' @rdname Counter_TraitR6
#' @export
`[[.Counter_TraitR6` <- `$.Counter_TraitR6`

# Trait methods and consts for Counter_TraitEnv implementing MatrixCounter
# Generated by #[miniextendr] impl MatrixCounter for Counter_TraitEnv

Counter_TraitEnv$MatrixCounter <- new.env(parent = emptyenv())

#' @name Counter_TraitEnv$MatrixCounter$custom_get
#' @rdname Counter_TraitEnv
Counter_TraitEnv$MatrixCounter$custom_get <- function(x) {
    .Call(C_Counter_TraitEnv__MatrixCounter__custom_get, .call = match.call(), x)
}

#' @name Counter_TraitEnv$MatrixCounter$custom_add
#' @rdname Counter_TraitEnv
Counter_TraitEnv$MatrixCounter$custom_add <- function(x, n) {
    .Call(C_Counter_TraitEnv__MatrixCounter__custom_add, .call = match.call(), x, n)
}

#' @name Counter_TraitEnv$MatrixCounter$default_value
#' @rdname Counter_TraitEnv
Counter_TraitEnv$MatrixCounter$default_value <- function() {
    .Call(C_Counter_TraitEnv__MatrixCounter__default_value, .call = match.call())
}

# S3 trait methods for Counter_TraitS3 implementing MatrixCounter
# Generated by #[miniextendr(s3)] impl MatrixCounter for Counter_TraitS3

#' S3 generic for `custom_get`
#' @name custom_get
#' @param x An object
#' @param ... Additional arguments passed to methods
#' @source Generated by miniextendr from `impl MatrixCounter for Counter_TraitS3`
#' @export
...
#' @rdname Counter_TraitS3
#' @export
#' @method custom_get Counter_TraitS3
custom_get.Counter_TraitS3 <- function(x, ...) {
    .Call(C_Counter_TraitS3__MatrixCounter__custom_get, .call = match.call(), x)
}
...
#' @rdname Counter_TraitS3
#' @export
#' @method custom_add Counter_TraitS3
custom_add.Counter_TraitS3 <- function(x, n, ...) {
    .Call(C_Counter_TraitS3__MatrixCounter__custom_add, .call = match.call(), x, n)
}

Counter_TraitS3$MatrixCounter <- new.env(parent = emptyenv())

#' Static trait method MatrixCounter::default_value()
#' @name Counter_TraitS3$MatrixCounter$default_value
#' @rdname Counter_TraitS3
Counter_TraitS3$MatrixCounter$default_value <- function() {
    .Call(C_Counter_TraitS3__MatrixCounter__default_value, .call = match.call())
}

# S4 trait methods for Counter_TraitS4 implementing MatrixCounter
# Generated by #[miniextendr(s4)] impl MatrixCounter for Counter_TraitS4

#' @importFrom methods setOldClass setGeneric setMethod isGeneric
methods::setOldClass("Counter_TraitS4")

#' S4 generic for trait method `MatrixCounter::custom_get`
#' @name s4_trait_MatrixCounter_custom_get
#' @rdname Counter_TraitS4
#' @source Generated by miniextendr from `impl MatrixCounter for Counter_TraitS4`
#' @export
...
methods::setMethod("s4_trait_MatrixCounter_custom_get", "Counter_TraitS4", function(x, ...) {
    .Call(C_Counter_TraitS4__MatrixCounter__custom_get, .call = match.call(), x)
})
...
methods::setMethod("s4_trait_MatrixCounter_custom_add", "Counter_TraitS4", function(x, n, ...) {
    .Call(C_Counter_TraitS4__MatrixCounter__custom_add, .call = match.call(), x, n)
})

#' Static trait method MatrixCounter::default_value() for Counter_TraitS4
#' @name Counter_TraitS4_MatrixCounter_default_value
#' @rdname Counter_TraitS4
#' @export
Counter_TraitS4_MatrixCounter_default_value <- function() {
    .Call(C_Counter_TraitS4__MatrixCounter__default_value, .call = match.call())
}

# S7 trait methods for Counter_TraitS7 implementing MatrixCounter
# Generated by #[miniextendr(s7)] impl MatrixCounter for Counter_TraitS7

#' @importFrom S7 new_generic method S7_dispatch new_S3_class
.s7_class_Counter_TraitS7 <- S7::new_S3_class("Counter_TraitS7")

#' S7 generic for trait method `MatrixCounter::custom_get`
#' @name s7_trait_MatrixCounter_custom_get
#' @rdname Counter_TraitS7
#' @source Generated by miniextendr from `impl MatrixCounter for Counter_TraitS7`
#' @export
...
S7::method(s7_trait_MatrixCounter_custom_get, .s7_class_Counter_TraitS7) <- function(x, ...) {
    .Call(C_Counter_TraitS7__MatrixCounter__custom_get, .call = match.call(), x)
}
...
S7::method(s7_trait_MatrixCounter_custom_add, .s7_class_Counter_TraitS7) <- function(x, n, ...) {
    .Call(C_Counter_TraitS7__MatrixCounter__custom_add, .call = match.call(), x, n)
}

Counter_TraitS7$MatrixCounter <- new.env(parent = emptyenv())

#' Static trait method MatrixCounter::default_value()
#' @name Counter_TraitS7$MatrixCounter$default_value
#' @rdname Counter_TraitS7
Counter_TraitS7$MatrixCounter$default_value <- function() {
    .Call(C_Counter_TraitS7__MatrixCounter__default_value, .call = match.call())
}

# R6 trait methods for Counter_TraitR6 implementing MatrixCounter
# Generated by #[miniextendr(r6)] impl MatrixCounter for Counter_TraitR6
# Note: R6 trait methods are standalone functions

#' R6 trait method `MatrixCounter::custom_get` for Counter_TraitR6
#' @name r6_trait_MatrixCounter_custom_get
#' @rdname Counter_TraitR6
#' @source Generated by miniextendr from `impl MatrixCounter for Counter_TraitR6`
#' @param x A `Counter_TraitR6` object
#' @export
r6_trait_MatrixCounter_custom_get <- function(x) {
    .Call(C_Counter_TraitR6__MatrixCounter__custom_get, .call = match.call(), x)
}

#' R6 trait method `MatrixCounter::custom_add` for Counter_TraitR6
...
r6_trait_MatrixCounter_custom_add <- function(x, n) {
    .Call(C_Counter_TraitR6__MatrixCounter__custom_add, .call = match.call(), x, n)
}

Counter_TraitR6$MatrixCounter <- new.env(parent = emptyenv())

#' Static trait method MatrixCounter::default_value()
#' @name Counter_TraitR6$MatrixCounter$default_value
#' @rdname Counter_TraitR6
Counter_TraitR6$MatrixCounter$default_value <- function() {
    .Call(C_Counter_TraitR6__MatrixCounter__default_value, .call = match.call())
}
