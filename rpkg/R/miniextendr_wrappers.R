...
ReceiverCounter$default_counter <- function() {
    result <- .Call(C_ReceiverCounter__default_counter)
...
#' @field .ptr (private) External pointer to Rust `R6Counter` struct
#' @export
...
#' @importFrom R6 R6Class
#' @field .ptr (private) External pointer to Rust `R6Accumulator` struct
#' @export
    ...
    public = list(
        initialize = function(.ptr = NULL) {
            if (!is.null(.ptr)) {
                ...
                private$.ptr <- .Call(C_R6Accumulator__new)
            }
        },
        accumulate = function(value) {
            .Call(C_R6Accumulator__accumulate, private$.ptr, value)
        },
        total = function() {
            .Call(C_R6Accumulator__total, private$.ptr)
        },
        count = function() {
            .Call(C_R6Accumulator__count, private$.ptr)
        },
        average = function() {
            .Call(C_R6Accumulator__average, private$.ptr)
        }
    ),
    private = list(
        .ptr = NULL
...
s3_add.S3Counter <- function(x, amount, ...) {
    .Call(C_S3Counter__s3_add, x, amount)
}
...
S7Counter <- S7::new_class("S7Counter",
    ...
    constructor = function(initial, .ptr = NULL) {
        if (!is.null(.ptr)) {
            ...
            S7::new_object(S7::S7_object(), .ptr = .Call(C_S7Counter__new, initial))
        }
    }
)

#' @title S7 method s7_value
#' @name s7_value
#' @rdname s7_value
#' @source Generated by miniextendr from `S7Counter::s7_value`
#' @export
if (!exists("s7_value", mode = "function")) s7_value <- S7::new_generic("s7_value", "x")
S7::method(s7_value, S7Counter) <- function(x) .Call(C_S7Counter__s7_value, x@.ptr)

#' @title S7 method s7_inc
#' @name s7_inc
#' @rdname s7_inc
#' @source Generated by miniextendr from `S7Counter::s7_inc`
#' @export
if (!exists("s7_inc", mode = "function")) s7_inc <- S7::new_generic("s7_inc", "x")
S7::method(s7_inc, S7Counter) <- function(x) .Call(C_S7Counter__s7_inc, x@.ptr)

#' @title S7 method s7_add
#' @name s7_add
#' @rdname s7_add
#' @source Generated by miniextendr from `S7Counter::s7_add`
#' @export
if (!exists("s7_add", mode = "function")) s7_add <- S7::new_generic("s7_add", "x")
S7::method(s7_add, S7Counter) <- function(x, amount) .Call(C_S7Counter__s7_add, x@.ptr, amount)

#' @source Generated by miniextendr from `S7Counter::default_counter`
#' @export
S7Counter_default_counter <- function() {
    S7Counter(.ptr = .Call(C_S7Counter__default_counter))
}
...
S4Counter <- function(initial) {
    methods::new("S4Counter", ptr = .Call(C_S4Counter__new, initial))
}

#' @title S4 method s4_value
#' @name s4_value
#' @rdname s4_value
...
methods::setMethod("s4_value", "S4Counter", function(x) .Call(C_S4Counter__value, x@ptr))

#' @title S4 method s4_inc
#' @name s4_inc
#' @rdname s4_inc
...
#' @exportMethod s4_inc
methods::setMethod("s4_inc", "S4Counter", function(x) .Call(C_S4Counter__inc, x@ptr))

#' @title S4 method s4_add
#' @name s4_add
#' @rdname s4_add
...
#' @exportMethod s4_add
methods::setMethod("s4_add", "S4Counter", function(x, amount) .Call(C_S4Counter__add, x@ptr, amount))

#' @source Generated by miniextendr from `S4Counter::default_counter`
#' @export
S4Counter_default_counter <- function() {
    methods::new("S4Counter", ptr = .Call(C_S4Counter__default_counter))
}
