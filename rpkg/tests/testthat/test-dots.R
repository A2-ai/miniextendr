...
test_that("greetings_with_nameless_dots() accepts variadic arguments", {
  # This one uses `...` directly in the signature
  expect_null(greetings_with_nameless_dots())
  expect_null(greetings_with_nameless_dots(1, 2, 3))
})

test_that("greetings_last_as_nameless_dots() accepts positional arg and dots", {
