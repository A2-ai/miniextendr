...
test_that("unsafe_C_r_error variants signal errors", {
  expect_error(rpkg:::unsafe_C_r_error(), "arg1")
  expect_error(rpkg:::unsafe_C_r_error_in_catch(), "arg1")
})
...
test_that("unsafe_C_r_error_in_thread is currently unsafe", {
  ...
  rpkg:::unsafe_C_r_error_in_thread()
})
