# Tests for vctrs construction support
#
# These tests verify that the vctrs construction helpers (new_vctr, new_rcrd,
# new_list_of) create correctly structured R objects compatible with vctrs.
#
