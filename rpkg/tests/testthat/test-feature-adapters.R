...
# Each feature is skipped if not enabled.

# Feature skip helper
skip_if_missing <- function(feature) {
  skip_if_not(feature %in% miniextendr::rpkg_enabled_features(),
              paste(feature, "feature not enabled"))
}
