+++
title = "Native-SEXP ALTREP Storage Guide"
weight = 50
description = "This guide explains the native-SEXP storage pattern for custom ALTREP vectors — where the backing data lives directly in the ALTREP data1 slot as a plain R vector, rather than being wrapped in an ExternalPtr."
+++
...
**See also**: [ALTREP.md](../altrep/) for the full ALTREP system documentation,
[ALTREP_QUICKREF.md](../altrep-quickref/) for the quick reference.
