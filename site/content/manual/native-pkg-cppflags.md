+++
title = "`NATIVE_PKG_CPPFLAGS` and `CLI_INCLUDE`"
weight = 50
description = "How miniextendr R packages pull headers from other R packages (anything listed in LinkingTo:) into the C-shim compilation step."
+++
