...
//! ## Usage Flow
//!
//! 1. Rust type implements trait(s) via `#[r_impl]`
//! 2. `r_object!` macro generates erased wrapper with vtables
...
/// a hash of the fully-qualified type/trait path. The `#[r_trait]` and
/// `r_object!` macros generate these automatically.
///
/// ## Comparison
///
...
/// ## Argument Handling
///
/// The shim generated by `#[r_trait]` is responsible for:
...
/// ## Generated By
///
/// The `r_object!` macro generates a static instance of this vtable
...
/// ## Generated By
///
/// The `r_object!` macro generates wrapper structs that have `mx_erased`
/// as their first field, ensuring proper layout for type erasure.
#[repr(C)]
pub struct mx_erased {
    /// Pointer to the base vtable.
    ///
    /// This must point to a valid, static vtable for the lifetime of the object.
    /// The vtable is typically a `static` generated by `r_object!`.
