...
//! method shims in `#[r_trait]`. These functions wrap the existing
//! [`TryFromSexp`] and [`IntoR`] traits with appropriate error handling.
//!
//! ## Purpose
//!
//! Method shims generated by `#[r_trait]` need to:
...
//! removing the need for users to specify a `conv_path` attribute.
//!
//! ## Error Handling
//!
